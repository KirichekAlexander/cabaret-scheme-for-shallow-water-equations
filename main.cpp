...
main() {
    ...
    //     , file_name + "_1", continuity, nullptr);
    // cabaret_scheme_1.compute();
    ...
    //     , file_name + "_2", continuity, nullptr);
    ...
    //     , file_name + "_3", continuity, nullptr);
    ...
    // double norm_1 = l2_norm(value_cabaret_scheme - interp_value_cabaret_scheme_2);
    // double norm_2 = l2_norm(value_cabaret_scheme_2 - interp_value_cabaret_scheme_4);
